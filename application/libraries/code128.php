...
class PDF_Code128 extends FPDF
{
    ...
    public $ABCset = ""; // jeu des caract�res �ligibles au C128
    public $Aset   = ""; // Set A du jeu des caract�res �ligibles
    public $Bset   = ""; // Set B du jeu des caract�res �ligibles
    public $Cset   = ""; // Set C du jeu des caract�res �ligibles
    ...
    public $JStart = array("A" => 103, "B" => 104, "C" => 105); // Caract�res de s�lection de jeu au d�but du C128
    public $JSwap  = array("A" => 101, "B" => 100, "C" => 99); // Caract�res de changement de jeu

//____________________________ Extension du constructeur _______________________
    public function PDF_Code128($orientation = 'P', $unit = 'mm', $format = 'A4')
    {
