...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="<?= base_url('assets/assets/images/favicon.icon') ;?>" type="image/x-icon">
				...
				<div class="">
					...
					<div class="collapse" id="nav-user-link">
						<ul class="list-unstyled">
							...
							<li class="list-group-item"><a href="<?= site_url().'/Teller/logout'?>"><i class="feather icon-log-out m-r-5"></i>Logout</a></li>
						</ul>
					</div>
				</div>
                        ...
                        <div class="dropdown-menu dropdown-menu-right notification">
                            ...
                            <ul class="noti-body">
                                ...
                                <li class="notification">
                                    <div class="media">
                                        <img class="img-radius" src="<?= base_url('assets/assets/images/user/avatar-1.jpg')?>" alt="Generic placeholder image">
                                ...
                                <li class="notification">
                                    <div class="media">
                                        <img class="img-radius" src="<?= base_url('assets/assets/images/user/avatar-2.jpg')?>" alt="Generic placeholder image">
                                        <div class="media-body">
                ...
                <li>
                    <div class="dropdown drp-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-notification">
                            <div class="pro-head">
                                <img src="<?= base_url('assets/assets/images/user/avatar-1.jpg')?>" class="img-radius" alt="User-Profile-Image">
                                <span>John Doe</span>
